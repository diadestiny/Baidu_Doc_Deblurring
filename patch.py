...
src = 'Datasets/doc_train'
tar = 'Datasets/train/doc'
...
lr_files = natsorted(glob(os.path.join(src, 'blur_image', '*.png')) + glob(os.path.join(src, 'blur_image', '*.jpg')))
hr_files = natsorted(glob(os.path.join(src, 'gt_image', '*.png')) + glob(os.path.join(src, 'gt_image', '*.jpg')))
...
# val_patch_size = 256
# src = 'Datasets/doc_test_10'
# tar = 'Datasets/val/doc'
#
# lr_tar = os.path.join(tar, 'input_crops')
# hr_tar = os.path.join(tar, 'target_crops')
#
